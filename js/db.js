    ...
    patients: [
        {
            ...
            history:[
                {date:'2026-08-23',done:false},
                {date:'2026-08-22',done:true},{date:'2026-08-21',done:true},
                {date:'2026-08-20',done:true},{date:'2026-08-19',done:false},
                {date:'2026-08-18',done:true},{date:'2026-08-17',done:true},
                {date:'2026-08-16',done:true},{date:'2026-08-15',done:true},
                {date:'2026-08-14',done:false},{date:'2026-08-13',done:true},
                {date:'2026-08-12',done:true},{date:'2026-08-11',done:true},
            ],
            tasks:[
                {name:'直腿抬高',count:10,unit:'次',keyPoints:'保持膝关节伸直',details:'仰卧位，腿抬高45°保持5秒，全程不弯曲膝关节',done:true},
                {name:'靠墙静蹲',count:30,unit:'秒',keyPoints:'膝关节不超过脚尖',details:'背靠墙，屈膝90°，保持腰背贴墙',done:true},
                {name:'踝泵运动',count:20,unit:'次',keyPoints:'足背充分屈伸',details:'踝关节最大幅度背伸及跖屈，各保持3秒',done:false},
                {name:'股四头肌等长收缩',count:15,unit:'次',keyPoints:'保持股四头肌紧绷',details:'主动收紧大腿前方肌肉，感觉膝关节压向床面，保持5秒',done:false},
            ],
            records:[
                {time:'09:12:05',action:'直腿抬高',pitch:44,abnormal:0,status:'标准'},
                {time:'09:18:30',action:'靠墙静蹲',pitch:68,abnormal:0,status:'标准'},
                {time:'09:25:10',action:'踝泵运动',pitch:32,abnormal:1,status:'纠正中'},
        ...
        },
        {
            ...
            history:[
                {date:'2026-08-23',done:false},
                {date:'2026-08-22',done:true},{date:'2026-08-21',done:false},
                {date:'2026-08-20',done:true},{date:'2026-08-19',done:true},
                {date:'2026-08-18',done:true},{date:'2026-08-17',done:false},
            ],
            tasks:[
                {name:'直腿抬高',count:15,unit:'次',keyPoints:'保持膝关节伸直',details:'仰卧位缓慢抬腿至45°',done:true},
                {name:'单腿支撑',count:15,unit:'次',keyPoints:'保持骨盆水平',details:'支撑腿微屈，控制5～10秒后换腿',done:false},
                {name:'蚌式开合',count:20,unit:'次',keyPoints:'保持骨盆稳定不旋转',details:'侧卧，上侧膝盖向上打开至最大幅度，缓慢回落',done:false},
            ],
            records:[
                {time:'10:15:00',action:'直腿抬高',pitch:48,abnormal:0,status:'标准'},
                {time:'10:20:30',action:'单腿支撑',pitch:28,abnormal:2,status:'纠正中'},
                {time:'14:22:30',action:'蚌式开合',pitch:38,abnormal:0,status:'标准'},
            ],
            monitorData:[],
        },
        {
            ...
            history:[
                {date:'2026-08-23',done:false},
                {date:'2026-08-22',done:false},{date:'2026-08-21',done:true},
                {date:'2026-08-20',done:true},{date:'2026-08-19',done:true},
            ],
            tasks:[
                {name:'靠墙静蹲',count:45,unit:'秒',keyPoints:'膝关节不超过脚尖',details:'背靠墙缓慢下蹲至大腿与地面平行',done:true},
                {name:'蚌式开合',count:20,unit:'次',keyPoints:'保持骨盆稳定',details:'侧卧练习，注意控制节奏',done:false},
                {name:'踝泵运动',count:20,unit:'次',keyPoints:'足背充分屈伸',details:'',done:false},
            ],
            records:[
                {time:'08:30:00',action:'靠墙静蹲',pitch:52,abnormal:0,status:'标准'},
                {time:'16:05:00',action:'蚌式开合',pitch:35,abnormal:1,status:'纠正中'},
            ],
            monitorData:[],
        },
        {
            ...
            tasks:[
                ...
                {name:'单腿支撑',count:10,unit:'次',keyPoints:'',details:'',done:false},
            ],
            records:[
                {time:'11:00:00',action:'直腿抬高',pitch:40,abnormal:0,status:'标准'},
            ],
            monitorData:[],
        },
        {
            ...
            history:[
                ...
                {date:'2026-08-20',done:true},{date:'2026-08-19',done:true},
                {date:'2026-08-18',done:true},{date:'2026-08-17',done:true},
                {date:'2026-08-16',done:true},{date:'2026-08-15',done:false},
            ],
            tasks:[
                {name:'单腿支撑',count:20,unit:'次',keyPoints:'保持平衡，核心收紧',details:'单脚站立，支撑腿微屈，对侧髋关节保持水平，控制5~10秒后换腿',done:true},
                {name:'蚌式开合',count:25,unit:'次',keyPoints:'保持骨盆稳定',details:'侧卧，双腿屈曲叠放，上侧膝盖向上打开至最大幅度',done:true},
